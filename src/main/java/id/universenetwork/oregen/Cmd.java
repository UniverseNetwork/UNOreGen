...
public class Cmd implements CommandExecutor {
    ...
    public Cmd(UNOreGen main) {
        this.plugin = main;
    }

    public boolean onCommand(CommandSender cs, Command arg1, String arg2, String[] args) {
        if (!cs.hasPermission("unoregen.admin")) {
    ...
    private void showHelp(CommandSender cs) {
        cs.sendMessage("§a/unoregen reload §2-Reloads the config.yml");
        cs.sendMessage("§a/unoregen inspect <player> §2-Returns information about the applied generator");
    }
}